...
#ETOPO1: NOAAより作成されたWGS84回転楕円体に準拠した全球1分メッシュ, 格子点数4億6656個のデジタル地形データ
#https://www.ngdc.noaa.gov/mgg/global よりDL
#オリジナルのETOPO1_Bed_g_geotiff.tifはサイズが大きいので(466.7MB)、日本周辺域（東経115—160, 北緯25-60）のtifを使用。
